...
function AboutPage({ title }: IAboutProps) {
  return (
    <MainLayout titleName="About Page">
      <div>
        ...
        <p>
          ...
          200 Latin words, combined with a handful of model sentence structures, to generate Lorem Ipsum which looks reasonable. The
